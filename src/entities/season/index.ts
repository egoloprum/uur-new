...
export const defaultSeasonData: Season[] = [
	...
	},
	{
		...
		slug: 'Khuch-chadal',
		description:
			'Биднийг хүрээлэн буй ертөнцийг хөдөлгөгч үл үзэгдэх эрчим. Магадгүй энэ нь аварга том хөдөлгүүрийн чимээ, эсвэл хүний оюун ухааны хязгааргүй боломж байж болох юм. Биднийг урагш хөтлөх технологийн хүч, нийгмийг удирдах улс төрийн хүч, байгаль дэлхийн нууцлаг хүч.',
		duration: '',
		serial: 1,
		isActive: true,
