...
import { Button, TopicsList } from '@/src/shared/components'
...
export const PreviousSeasonPostsSection = ({}) => {
	...
	return (
		<div className="space-y-8">
			<div className="flex flex-col lg:flex-row flex-wrap gap-x-8 gap-y-4 justify-between px-4 md:px-8 lg:px-12 xl:px-16">
