...
export const CurrentSeasonPostsSection = ({}) => {
	const { getPostsBySeasonId, getTopicById, getMemberById, currentSeasonId } =
		useApp()
				...
				<div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-8">
					<div className="flex flex-col md:flex-row max-sm:flex-row md:items-center gap-2 max-sm:gap-4 md:gap-8">
						<p className="flex gap-2">
							<span className="h-3 w-3 md:h-4 md:w-4 aspect-square rounded-full bg-(--black) dark:bg-(--black)"></span>
