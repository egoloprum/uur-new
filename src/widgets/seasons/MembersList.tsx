	...
	return (
		<ul className="">
			{members.map((member, index) => (
				<li
					className={clsx([
						'px-4 md:px-8 lg:px-12 xl:px-16 py-4 md:py-6 border-t border-stone-400 dark:border-stone-500',
						'flex max-sm:flex-col sm:items-center sm:justify-between',
						'md:hover:bg-indigo-300 md:hover:dark:bg-[#91a3ff] md:hover:px-12 transition-all duration-300',
